                ...
                <ul class="xoxo">
                    <li id="aabningstider" class="widget">
                        ...
                        <ul>
                            ...
                            <li>Kj&oslash;kkenet er &aring;pent til 19.</li>
                        </ul>
                    </li>
                    <li id="grisebanner" class="widget">
                        <ul>
                            <li><a href="http://studentersamfundet.no/hmgrisen/"><img src="http://studentersamfundet.no/bilder/bannere/grisebanner.png" alt="Hans Majestet Grisen fyller 150 &aring;r!" /></a></li>
                        </ul>
                    </li>
                    <!--li>
                        <h3>Sidebar element</h3>
