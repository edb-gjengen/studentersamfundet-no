            ...
            <article id="post-<?php the_ID(); ?>" <?php neuf_post_class(); ?>>
                ...
                <div class="entry-meta">
                    ...
                    <?php if( $feat_post->post_type == 'event'): ?>
                        <span class="event-types"><?php echo get_event_types($feat_post); ?></span>
                        <span class="event-datetime"><?php echo ucfirst( date_i18n( 'l j. F' , $feat_post->neuf_events_starttime ) ); ?></span>
