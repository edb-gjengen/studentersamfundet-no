...
add_image_size( 'newsletter-half'   , 320 , 190, false );
add_image_size( 'newsletter-third'  , 213 , 126, false );
...
function neuf_enqueue_scripts() {
	...
	wp_register_script( 'jquery'    , '//ajax.googleapis.com/ajax/libs/jquery/1.6/jquery.min.js' );
